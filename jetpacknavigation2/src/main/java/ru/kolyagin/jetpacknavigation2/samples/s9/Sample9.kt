package ru.kolyagin.jetpacknavigation2.samples.s9
...
import ru.kolyagin.jetpacknavigation2.samples.s9.DetailsDestination.Companion.detailsComposable
import ru.kolyagin.jetpacknavigation2.samples.s9.HomeDestination.Companion.homeComposable
import ru.kolyagin.jetpacknavigation2.samples.s9.ListDestination.Companion.listComposable
    ...
    companion object {
        ...
        fun NavGraphBuilder.detailsComposable() {
            composable(
                ...
                val stringValue = URLDecoder.decode(
                    backStackEntry.arguments?.getString("stringValue")!!,
        ...
        fun createRoute(item: Item): String {
            return "details/${
                URLEncoder.encode(item.stringField, StandardCharsets.UTF_8.toString())
            }/${item.intField}/?value=${item.nullableIntField}"
        }
    }
}
